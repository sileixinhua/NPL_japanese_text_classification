...
public class WebSpider {
    ...
    public static void main(String[] args) {
        String web_site_key="アメリカ合衆国の経済史";
        String web_site_url="https://ja.wikipedia.org/wiki/"+web_site_key;
        try{
            ...
            if (code == HttpURLConnection.HTTP_OK)
            {
                ...
                System.out.println("网页文本内容写入"+"./data/"+web_site_key+".txt"+"。。。");
                while ((inputLine = in.readLine()) != null) {
                    ...
                    writeIntoFile(inputLine,"./data/"+web_site_key+".txt", true);
                }
                in.close();
            }
            else
